     ...
     if(channel == 3 || channel == 4) {
         if(document.getElementById("dataTargetGroup").files.length > 0){
             ...
             if(fileExtensionDataTargetGroup != "csv"){
                 ...
                 let useFileMSISDN = $("#useFileMSISDN").val();
                 if(useFileMSISDN == 'false'){
 ...
 function checkTargetGroupNameUpdate(name,id) {
     var value = true;
     console.log("id:",id);
     $.ajax({
         type: 'GET',
         url: '/TargetGroupController/checkTargetGroupNameUpdate?name=' + name + "&id=" +id,
         traditional: true,
         async: false,
         dataType: 'JSON',
