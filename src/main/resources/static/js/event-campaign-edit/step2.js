    ...
    $('#condition-container').on('change',".select-operator .calendar", function(){
        if (this.value == "><") {
            ...
            let htmlParam = "<div class=\"col-lg-5 div-param\">" +
                ...
                "      <input class=\"form-control condition-date condition-value\" data-order=\"start\" style='width: 50%' placeholder='Từ ngày'>" +
                "      <input class=\"form-control condition-date condition-value\" data-order=\"end\" style='width: 50%' placeholder='Đến ngày'>" +
                "   </div>" +
                "</div>";
            let divParam = $.parseHTML(htmlParam);
            divDataInput.append($(divParam));
