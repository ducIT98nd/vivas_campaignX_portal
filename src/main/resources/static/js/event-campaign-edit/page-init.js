...
$(document).ready(function () {
    ...
    /*let startDate = "10/03/2022";
    let endDate = "11/03/2022";*/
    ...
    $.ajax({
        ...
        success: function (response) {
            if (response) {
                ...
                let eventConditionList = response.eventConditions;
